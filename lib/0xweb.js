...
var _dequanto_src_safe_GnosisSafe = {};
...
var _node_modules_ethereumjs_util_dist_index = {};
var _src_app_App = {};
...
var $validate;
(function ($validate) {
    $validate.platforms = ['eth', 'polygon', 'bsc', 'hardhat'];
...
function $color(str) {
    const COLOR = _const_1.is_BROWSER
        ? ColorData.ColorNone
...
class HardhatProvider {
    ...
    async resolve(Ctor, ...params) {
        return this.resolveForSigner(null, Ctor, ...params);
    }
    async resolveForSigner(signer, Ctor, ...params) {
        let ethers = this.hh.ethers;
        let Factory = await ethers.getContractFactory(Ctor.name);
        if (signer != null) {
...
__decorate([
    memd_1.default.deco.memoize()
], HardhatProvider.prototype, "resolve", null);
__decorate([
    memd_1.default.deco.memoize()
], HardhatProvider.prototype, "resolveForSigner", null);
...
(function (Web3ClientFactory) {
    function get(platform, opts) {
        switch (platform) {
            ...
            case 'hardhat':
                return a_di_1.default.resolve(HardhatProvider_1.HardhatProvider).client();
            default:
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _node_modules_ethereumjs_util_dist_index != null ? _node_modules_ethereumjs_util_dist_index : {};
    var module = { exports: exports };
...
//# sourceMappingURL=index.js.map;
    ...
    if (_node_modules_ethereumjs_util_dist_index === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_ethereumjs_util_dist_index) && __isObj(module.exports)) {
        Object.assign(_node_modules_ethereumjs_util_dist_index, module.exports);
    } else {
        _node_modules_ethereumjs_util_dist_index = module.exports;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.$sign = void 0;
const ethereumjs_util_1 = _node_modules_ethereumjs_util_dist_index;
const _buffer_1 = _dequanto_src_utils__buffer;
const _is_1 = _dequanto_src_utils__is;
var $sign;
(function ($sign) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _dequanto_src_safe_GnosisSafe != null ? _dequanto_src_safe_GnosisSafe : {};
    var module = { exports: exports };
...
const _fn_1 = _dequanto_src_utils__fn;
class GnosisSafe {
    constructor(safeAddress, owner, client = a_di_1.default.resolve(EthWeb3Client_1.EthWeb3Client)) {
    ...
    async confirmTx(safeTxHash) {
        let service = await this.getService();
        let signature = _sign_1.$sign.signEC(safeTxHash, this.owner.key);
        let resp = await service.confirmTransaction(safeTxHash, signature.signature);
        return resp;
    }
    async submitTransaction(safeTxHash) {
        let service = await this.getService();
        ...
        let myConfirmation = confirmations.find(x => _address_1.$address.eq(x.owner, this.owner.address));
    ...
    async createTransaction(writer, value) {
        ...
        signatures.set(this.owner.address.toLowerCase(), {
            ...
            data: _sign_1.$sign.signEC(hash, this.owner.key).signature
        });
...
__decorate([
    memd_1.default.deco.memoize({ perInstance: true })
], GnosisSafe.prototype, "getService", null);
__decorate([
    memd_1.default.deco.memoize({ perInstance: true })
], GnosisSafe.prototype, "getSafeSdk", null);
__decorate([
    memd_1.default.deco.memoize({ perInstance: true })
], GnosisSafe.prototype, "getAdapter", null);
__decorate([
    memd_1.default.deco.memoize()
], GnosisSafe.prototype, "getServiceApiEndpoint", null);
...
;
    ...
    if (_dequanto_src_safe_GnosisSafe === module.exports) {
        // do nothing if
    } else if (__isObj(_dequanto_src_safe_GnosisSafe) && __isObj(module.exports)) {
        Object.assign(_dequanto_src_safe_GnosisSafe, module.exports);
    } else {
        _dequanto_src_safe_GnosisSafe = module.exports;
    }
...
const GnosisSafe_1 = _dequanto_src_safe_GnosisSafe;
const _account_1 = _dequanto_src_utils__account;
class TxWriter extends atma_utils_1.class_EventEmitter {
    ...
    async sendTxInner() {
        if (this.isSafe) {
            ...
            let safe = new GnosisSafe_1.GnosisSafe(safeAccount.safeAddress, sender, this.client);
