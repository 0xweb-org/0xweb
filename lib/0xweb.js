...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _dequanto_src_evm_opcodes != null ? _dequanto_src_evm_opcodes : {};
    var module = { exports: exports };

    'use strict';
Object.defineProperty(exports, "__esModule", { value: true });
exports.findOpcode = void 0;
var codes = {
...
function findOpcode(op, full, freeLogs) {
...
;
    ...
    if (_dequanto_src_evm_opcodes === module.exports) {
        // do nothing if
    } else if (__isObj(_dequanto_src_evm_opcodes) && __isObj(module.exports)) {
        Object.assign(_dequanto_src_evm_opcodes, module.exports);
    } else {
        _dequanto_src_evm_opcodes = module.exports;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.EVM = void 0;
const opcodes_1 = _dequanto_src_evm_opcodes;
...
class App {
    ...
    async execute(argv) {
        ...
        if ('help' in cliParams) {
            await (0, CHelp_1.CHelp)().printCommand(command, paramsDefinition);
            return null;
        }
