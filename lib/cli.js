...
class Web3Client {
    ...
    async getPastLogs(options) {
        ...
        const fetch = async (maxBlockRange) => {
...
class TokenDataProvider {
    constructor(platform, explorer) {
        ...
        this.providers = [
            ...
            new TPChain_1.TPExplorer(this.platform, this.explorer),
        ];
    }
    ...
    async getTokenByAddress(address, chainLookup = true) {
        let [token, provider] = await (0, alot_1.default)(this.providers)
            ...
            if (provider instanceof TPChain_1.TPExplorer && chainLookup === false) {
                return [null, null];
                ;
            }
        ...
        },
        {
            ...
            async process(args, params, app) {
                ...
                let tokenAddresses = (0, alot_1.default)(trasfers)
                    ...
                    .distinct()
                    .toArray();
                _console_1.$console.log(tokenAddresses.join('\n'));
...
class App {
    ...
    async execute(argv) {
        ...
        if (platform) {
            let opts = {};
            let network = _cli_1.$cli.getParamValue('--network', params);
            if (network) {
