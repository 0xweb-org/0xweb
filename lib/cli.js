...
var _dequanto_contracts_gen_base_ERC20Base = {};
...
var _dequanto_src_ChainAccounts = {};
...
var _dequanto_src_clients_utils_TxFactory = {};
...
var _node_modules_web3_utils_lib_index = {};
var _src_app_App = {};
...
class Config {
    static async fetch() {
        let unlockedAccounts = await _secret_1.$secret.get();
...
(function ($command) {
    ...
    function getParams(cliParams, paramsDef) {
        let params = {};
        let keyMappings = {};
        let definitions = {};
...
var $validate;
(function ($validate) {
    $validate.platforms = ['eth', 'polygon', 'bsc'];
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_utils__color != null ? _src_utils__color : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_utils__color === module.exports) {
        // do nothing if
    } else if (__isObj(_src_utils__color) && __isObj(module.exports)) {
        Object.assign(_src_utils__color, module.exports);
    } else {
        _src_utils__color = module.exports;
    }
...
const _color_1 = _src_utils__color;
...
(function ($console) {
    ...
    function log(str) {
        ...
        write({ str: (0, _color_1.$color)(str) });
    }
    $console.log = log;
    function toast(str) {
        write({ str: (0, _color_1.$color)(str), isToast: true });
    }
    $console.toast = toast;
    function table(arr) {
        let lengths = arr[0].map((row, i) => {
            let size = (0, alot_1.default)(arr).max(x => x[i].length);
            return size;
        });
...
exports.CHelp = {
    ...
    async process(args, params, app) {
        ...
        _console_1.$console.log('! We provide our Demo Keys for etherscan and co. Please, replace them with yours: bold<0xweb config -e>');
        _console_1.$console.log('');
...
class CommandsHandler {
    ...
    async process(cliArgs, cliParams, app) {
        ...
        if (cliParams.help) {
            CHelp_1.CHelp.printCommand(command);
            return;
        }
        let params = _command_1.$command.getParams(cliParams, command.params);
        ...
        if (args.length > 0 && command.subcommands?.length > 0) {
            ...
            if (subCommand != null) {
                if (subCommand.params != null) {
                    let subCommandParams = _command_1.$command.getParams(cliParams, subCommand.params);
                    params = {
                        ...params,
                        ...subCommandParams,
                    };
                ...
                args = args.slice(1);
                _validate_1.$validate.args(subCommand, args);
...
const Formatter = __importStar(_node_modules_atma_formatter_lib_format_min);
class DateTool {
...
class WClient {
    constructor(mix) {
        ...
        if (hasUrl || hasWeb3) {
            this.config = mix;
            this.web3 = mix.web3 ?? new web3_1.default(mix.url);
        }
        else {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _dequanto_src_clients_utils_TxFactory != null ? _dequanto_src_clients_utils_TxFactory : {};
    var module = { exports: exports };
...
;
    ...
    if (_dequanto_src_clients_utils_TxFactory === module.exports) {
        // do nothing if
    } else if (__isObj(_dequanto_src_clients_utils_TxFactory) && __isObj(module.exports)) {
        Object.assign(_dequanto_src_clients_utils_TxFactory, module.exports);
    } else {
        _dequanto_src_clients_utils_TxFactory = module.exports;
    }
...
const Web3Client_1 = _dequanto_src_clients_Web3Client;
const ClientEndpoints_1 = _dequanto_src_clients_utils_ClientEndpoints;
const TxFactory_1 = _dequanto_src_clients_utils_TxFactory;
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _dequanto_src_ChainAccounts != null ? _dequanto_src_ChainAccounts : {};
    var module = { exports: exports };
...
;
    ...
    if (_dequanto_src_ChainAccounts === module.exports) {
        // do nothing if
    } else if (__isObj(_dequanto_src_ChainAccounts) && __isObj(module.exports)) {
        Object.assign(_dequanto_src_ChainAccounts, module.exports);
    } else {
        _dequanto_src_ChainAccounts = module.exports;
    }
...
const _console_1 = _src_utils__console;
const ChainAccounts_1 = _dequanto_src_ChainAccounts;
class AccountsService {
    ...
    async create(name) {
        ...
        let account = await ChainAccounts_1.ChainAccountProvider.generate({ name, platform: 'eth' });
    ...
    subcommands: [
        {
            ...
            async process(args, params, app) {
                ...
                if (key) {
                    let addr = ChainAccounts_1.ChainAccountProvider.getAddressFromKey(key);
                    if (address != null && _address_1.$address.eq(addr, address)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _node_modules_web3_utils_lib_index != null ? _node_modules_web3_utils_lib_index : {};
    var module = { exports: exports };
...
;
    ...
    if (_node_modules_web3_utils_lib_index === module.exports) {
        // do nothing if
    } else if (__isObj(_node_modules_web3_utils_lib_index) && __isObj(module.exports)) {
        Object.assign(_node_modules_web3_utils_lib_index, module.exports);
    } else {
        _node_modules_web3_utils_lib_index = module.exports;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.$ns = void 0;
const web3_utils_1 = _node_modules_web3_utils_lib_index;
var $ns;
(function ($ns) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _dequanto_contracts_gen_base_ERC20Base != null ? _dequanto_contracts_gen_base_ERC20Base : {};
    var module = { exports: exports };
...
;
    ...
    if (_dequanto_contracts_gen_base_ERC20Base === module.exports) {
        // do nothing if
    } else if (__isObj(_dequanto_contracts_gen_base_ERC20Base) && __isObj(module.exports)) {
        Object.assign(_dequanto_contracts_gen_base_ERC20Base, module.exports);
    } else {
        _dequanto_contracts_gen_base_ERC20Base = module.exports;
    }
...
const ERC20Base_1 = _dequanto_contracts_gen_base_ERC20Base;
    ...
    subcommands: [
        {
            ...
            async process(args, params, app) {
                ...
                _console_1.$console.toast(`Loading balance for ${account.address}`);
...
class ContractService {
    ...
    async getContractWriter(pckg, abi, params) {
        ...
        let writer = a_di_1.default.resolve(ContractWriter_1.ContractWriter, pckg.address, this.app.chain.client);
        return writer;
    }
...
class InitWorker {
    constructor(directory, params) {
        ...
        this.params = params;
        this.repo = `https://github.com/tenbits/dequanto.git`;
    }
    async init() {
...
class App {
    ...
    async execute() {
        let platform = _cli_1.$cli.getParamValue('-c, --chain') ?? 'eth';
        _console_1.$console.toast('Load config');
        ...
        let name = args[0];
        if (name) {
            _console_1.$console.toast(`Process command gray<${args[0]}>`);
        }
