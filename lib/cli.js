...
var Web3ContractRequest;
(function (Web3ContractRequest) {
    function request(web3, request, onComplete) {
    ...
    Web3ContractRequest.BatchRequest = BatchRequest;
...
})(Web3ContractRequest || (Web3ContractRequest = {}));
;
...
class EthWeb3Client extends Web3Client_1.Web3Client {
    constructor(opts) {
        super({
            ...(opts ?? {}),
            endpoints: ClientEndpoints_1.ClientEndpoints.filterEndpoints(_config_1.$config.get(`web3.${opts?.platform ?? 'eth'}.endpoints`), opts)
        });
